...
proc drawWindow(ctx: ptr NVGContext, title: string, x, y, w, h: float) =
  ...
  shadowPaint.innerColor = NVGColor(ano_377390029: INNER_C_UNION_3941339160(rgba:[0.cfloat,0,0,128/255]))
  shadowPaint.outerColor = NVGColor(ano_377390029: INNER_C_UNION_3941339160(rgba:[0.cfloat,0,0,0/255]))
  nvgBeginPath(ctx)
  ...
  # Header
  headerPaint = nvgLinearGradient(ctx, x,y,x,y+15, nvgRGBA(0.cuchar,0.cuchar,0.cuchar,128.cuchar), nvgRGBA(0.cuchar, 0.cuchar, 0.cuchar , 16.cuchar) )
  nvgBeginPath(ctx)
...
proc loadDemoData(data: var DemoData) =
